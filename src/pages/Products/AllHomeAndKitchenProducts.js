...
const AllHomeAndKitchenProducts = () => {
    const productState = useSelector(state => state.products.allProducts);
    const allHomeAndKitchenProducts = productState.filter(pd => pd.category === 'Home and kitchen')
    return (
        <>
            ...
            <div>
                <div className="max-w-2xl mx-auto pt-16 px-4 lg:pb-1 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-1">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-1">
                        {allHomeAndKitchenProducts.map((product) => (
...
export default AllHomeAndKitchenProducts;
