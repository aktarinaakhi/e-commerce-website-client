...
const Register = () => {
    ...
    const { user, registerUser, isLoading, error, signInWithGoogle, logOut } = useAuth();
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="#" method="POST">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <label htmlhtmlFor="remember-me" className="ml-2 block text-sm text-gray-900">
                                    Remember me
                                </label>
                            </div>
                        ...
                        <div>
                            <input type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-5" name="SignIn" value="Register" />
                        </div>

                        <div className='text-center'>
                            <span>Already register?</span>
                            <Link to='/login'>
                                <button className="ml-3"> Please Login</button>
